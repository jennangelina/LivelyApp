...
class study_tips : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rvArticle = findViewById(R.id.rvStudy)
    ...
    private fun TampilkanData() {
        ...
        db.collection("articles")
            .whereEqualTo("article_category","Study Tips")
            .get()
        ...
        adapterArt.setOnItemClickCallback(object: adapterArticle.OnItemClickCallBack {
            override fun onItemClicked(data: Articles){
                Toast.makeText(this@study_tips, data.article_title, Toast.LENGTH_LONG).show()
            }
