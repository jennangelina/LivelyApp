...
class books_recommend : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rvArticle = findViewById(R.id.rvBooks)
    ...
    private fun TampilkanData() {
        ...
        db.collection("articles")
            .whereEqualTo("article_category","Books Recommendation")
            .get()
        ...
        adapterArt.setOnItemClickCallback(object: adapterArticle.OnItemClickCallBack {
            override fun onItemClicked(data: Articles){
                Toast.makeText(this@books_recommend, data.article_title, Toast.LENGTH_LONG).show()
            }
